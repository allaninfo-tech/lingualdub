...
def test_result_mark_partial():
    result = Result()
    result = result.mark_partial("alignment skipped")
...
def test_result_mark_failed():
    result = Result()
    result = result.mark_failed("fatal error")
...
def test_result_mark_degraded():
    result = Result()
    result = result.mark_degraded("poor audio quality")
...
def test_result_add_warning():
    result = Result()
    result = result.add_warning("something minor")
    assert result.status == ResultStatus.COMPLETE
...
def test_result_multiple_warnings():
    result = Result()
    result = result.add_warning("first")
    result = result.add_warning("second")
